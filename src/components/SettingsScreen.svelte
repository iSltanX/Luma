      ...
      <div class="column">
        ...
        {:else}
          ...
          <section class="group" aria-label="الخطوط والتراخيص">
            ...
            <p class="note">
              {isolate("Almarai")} خط الكتابة و{isolate("Cairo")} خط الواجهة،
              وكلاهما تحت رخصة الخط المفتوح {isolate("SIL OFL 1.1")}. نصّ
              الرخصة وحقوق النشر داخل التطبيق في
              {isolate("Contents/Resources/fonts/")}.
            </p>
            <p class="note">
              والخط الذي تستورده يُنسخ إلى مجلد بياناتك ليُرسم به نصّك عند كل
              إقلاع. النسخة على جهازك وحده، و<strong>التزام ترخيصه
              مسؤوليتك</strong>: الاستيراد استعمال شخصي ولا يمنحك حقوقًا لا
              يمنحها ترخيص الخط.
            </p>
          </section>
        {/if}

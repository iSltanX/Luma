...
<p align="center">
  <img src="https://img.shields.io/badge/version-V1.0-B67642?style=flat-square" alt="الإصدار V1.0" />
  <img src="https://img.shields.io/badge/status-under_development-C07A3D?style=flat-square" alt="قيد التطوير" />
...
> [!IMPORTANT]
> **حالة المشروع:** الإصدار **V1.0** قيد التطوير حاليًا. يجري إعداد النسخة الموقّعة والتوزيع العام، وقد تتغير بعض التفاصيل قبل الإطلاق الرسمي.
...
| التوزيع العام | قيد الإعداد |

يركّز **V1.0** على وضع أساس متين لتجربة كتابة عربية هادئة: محرر سريع، حفظ يمكن الوثوق به، مكتبة خفيفة، سجل زمني، محرر مريح، وخيارات مظهر تخدم القراءة الطويلة من دون تحويل الكتابة إلى لوحة تحكم.
...
> هذا المسار مخصص للمطورين خلال فترة تطوير V1.0، وليس طريقة تثبيت لإصدار عام.
